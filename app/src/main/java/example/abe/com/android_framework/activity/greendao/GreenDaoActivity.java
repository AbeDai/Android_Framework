...
public class GreenDaoActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        baseAdapter.addItemViewDelegate(new UserItemDelegate());
        HeaderAndFooterWrapper headWrapper = new HeaderAndFooterWrapper(baseAdapter);
        headWrapper.addHeaderView(getHeader());
    ...
    private View getHeader(){
        return LayoutInflater.from(this).inflate(R.layout.item_user_info_view, null);
    }
}